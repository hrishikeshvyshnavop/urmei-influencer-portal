...
const variants: Record<ButtonVariant, string> = {
  ...
  portalOutline: "rounded-lg border border-portal-border px-4 py-2 text-body-sm text-portal-text",
  portalOutlineLg: "rounded-lg border border-portal-border px-4 py-3 text-body-sm text-portal-text",
