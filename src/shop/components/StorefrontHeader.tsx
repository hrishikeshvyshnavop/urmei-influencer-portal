 ...
 *  sticky-vs-`ScaledBox` note there. */
export function StorefrontHeader({ onClose }: { onClose: () => void }) {
  return (
    <header
      className="flex w-full items-center justify-between rounded-b-[16px] border-b border-border-default bg-surface-secondary-100 px-margin py-md-2"
